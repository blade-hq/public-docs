---
title: "对话与交互"
description: 对话与交互的配置、使用步骤、接口行为和排查说明。
---
...
<img src="../../images/chat-send-message.png" alt="发送消息">
...
<img src="../../images/chat-file-upload.png" alt="上传文件">

## 图片附件

消息中可以直接粘贴或上传图片，智能体支持多模态理解，能够识别和分析图片中的内容。

<img src="../../images/chat-image-attachment.png" alt="图片附件">
